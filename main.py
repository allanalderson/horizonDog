...
smoothing_window = 5  # Adjust this value as needed. Typ: 5
angle_buffer = []
...
while True:
	...
	#small_frame = cv2.resize(frame, None, fx=0.4, fy=0.4, interpolation=cv2.INTER_LINEAR)
	desired_height = 200
	...
	# Check if line is approximately horizontal
		if abs(avg_y2 - avg_y1) < 180:
			...
			#print("Smoothed average angle:", smoothed_average_angle)
	else:
		print("No lines ")
		smoothed_average_angle = 0
	...
	# Rotate the frame to align horizon horizontally
